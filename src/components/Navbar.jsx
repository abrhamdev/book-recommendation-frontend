...
const Navbar = () => {
  ...
  const menuItems = [
    ...
    { 
      ...
      path: '/books',
      dropdown: [
        { title: 'Art', path: '/discover' },
        { title: 'Biography', path: '/books/biography' },
        { title: 'Business', path: '/books/business' },
        { title: "Children's", path: '/books/children' },
        { title: 'Christian', path: '/books/christian' },
        { title: 'Classics', path: '/books/classics' },
        { title: 'Comics', path: '/books/comics' },
        { title: 'Cookbooks', path: '/books/cookbooks' },
        { title: 'Fantasy', path: '/books/fantasy' },
        { title: 'Fiction', path: '/books/fiction' },
        { title: 'Graphic Novels', path: '/books/graphic-novels' },
        { title: 'Historical Fiction', path: '/books/historical-fiction' },
        { title: 'History', path: '/books/history' },
        { title: 'Horror', path: '/books/horror' },
        { title: 'Humor', path: '/books/humor' },
        { title: 'Manga', path: '/books/manga' },
        { title: 'Memoir', path: '/books/memoir' },
        { title: 'Music', path: '/books/music' },
        { title: 'Mystery', path: '/books/mystery' },
        { title: 'Nonfiction', path: '/books/nonfiction' },
        { title: 'Poetry', path: '/books/poetry' },
        { title: 'Psychology', path: '/books/psychology' },
        { title: 'Romance', path: '/books/romance' },
        { title: 'Science', path: '/books/science' },
        { title: 'Science Fiction', path: '/books/science-fiction' },
        { title: 'Self Help', path: '/books/self-help' },
        { title: 'Sports', path: '/books/sports' },
        { title: 'Thriller', path: '/books/thriller' },
        { title: 'Travel', path: '/books/travel' },
        { title: 'Young Adult', path: '/books/young-adult' }
      ]
    },
